...
import { ReactComponent as NoAvatar } from "../../../assets/images/icons/NoAvatar.svg";
import { ReactComponent as Optinal } from "../../../assets/images/icons/Optinal.svg";
import { ReactComponent as EyeHidden } from "../../../assets/images/icons/EyeHidden.svg";
import { ReactComponent as EyeShow } from "../../../assets/images/icons/EyeShow.svg";
          ...
          <span
            ...
            style={
              tab
                ...
                : { transform: "translateX(145px)", width: "240px" }
            }
          ></span>
          <span
      ...
      {tab ? (
        <form className="loginContainer" onSubmit={handleSubmit}>
          <div className="loginContainer__1">
            ...
            {errors.username && (
              <div>
                <div className="error-message input-title text-red-600">
          ...
          <div className="divPassword">
            ...
            />
            {errors.password && (
              <span className="error-message enterPassword text-red-600">
        ...
        <section className="modalRegistration">
          ...
          <form action="" className="form" onSubmit={handleSubmit2}>
            <div className="formDiv1">
              ...
              />
              {errors2.first_name && (
                <span className="error-message formDiv1-text text-red-600">
                  Ismingizni kiriting !
                </span>
              )}
            </div>
            <div className="formDiv2">
              ...
              />
              {errors2.last_name && (
                <span className="error-message formDiv2-text text-red-600">
            ...
            <div className="formDiv3">
              ...
              />
              {errors2.email && (
                <span className="error-message formDiv3-text text-red-600">
            ...
            <div className="formDiv4">
              ...
              />
              {errors2.username && (
                <span className="error-message formDiv4-text text-red-600">
                  Raqamingizni kiriting !
                </span>
              )}
            </div>
